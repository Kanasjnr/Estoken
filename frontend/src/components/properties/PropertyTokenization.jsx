...
const PropertyTokenization = () => {
  ...
  <CardHeader className="bg-gradient-to-r from-blue-500 to-purple-500 p-8">
    ...
    <CardDescription className="text-xl text-gray-700">Transform your real estate into digital assets</CardDescription>
  </CardHeader>
    ...
    <ScrollArea className="h-[60vh] pr-4">
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4">
          <Label htmlFor="images" className="text-lg font-semibold text-gray-700">Property Images</Label>
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="advanced-mode" className="text-lg font-semibold text-gray-700">Advanced Mode</Label>
          <TooltipProvider>
            <Tooltip>
        ...
        <AnimatePresence>
          {advancedMode && (
            ...
            >
              <div className="space-y-2">
                <Label htmlFor="totalShares" className="text-lg font-semibold text-gray-700">Total Shares</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label htmlFor="pricePerShare" className="text-lg font-semibold text-gray-700">Price Per Share (ETH)</Label>
                <div className="relative">

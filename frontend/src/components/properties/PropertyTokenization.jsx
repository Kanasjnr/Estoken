...
const PropertyTokenization = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(`Error tokenizing property: ${err.message}`);
    }
  };
              ...
              <AnimatePresence>
                {advancedMode && (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      {" "}
                      {/* Added new input field for initialValuation */}
                      <Label
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          type="number"
                          step="0.000001"
                          value={formData.totalRentalIncome}
                          onChange={handleInputChange}
                          required
                          className="text-lg pl-10 bg-gray-100 border-gray-300 focus:border-blue-500 text-gray-900"
                          placeholder="100"

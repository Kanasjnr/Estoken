    ...
    try {
      ...
      for (let i = 1; i <= total; i++) {
        try {
          ...
          // Format monthlyRentalIncome array
          const monthlyRentalIncome = financials.monthlyRentalIncome
            ? financials.monthlyRentalIncome.map((income) => ethers.formatEther(income))
            : [];
          ...
          fetchedProperties.push({
            ...
            monthlyRentalIncome, // Add formatted monthlyRentalIncome array
